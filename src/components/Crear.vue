...
export default {
    ...
    methods:{
        agregarRegistro(){
            ...
            var datosEnviar = {nombre:this.cliente.nombre, apellidoPaterno:this.cliente.apellidoPaterno, apellidoMaterno:this.cliente.apellidoMaterno, rfc:this.cliente.rfc, curp:this.cliente.curp}

            fetch('http://localhost/API_REST_PHP/clientes.php?insertar=1',{
